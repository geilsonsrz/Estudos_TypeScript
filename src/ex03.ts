/**
 * Exercício 03 - INTERFACE / Consumir a API pública do GitHub
 */

//Criação da Interface para a resposta do GitHub referentes aos usuarios
...
async function main() {
    ...
    */
    ...
    await fetchUser('geilsonsrz')
    await showUser('geilsonsrz')
}
